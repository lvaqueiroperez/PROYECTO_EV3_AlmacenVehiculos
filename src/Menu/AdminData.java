...
public class AdminData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Direccion", "Telf", "PrecioT", "UnidadesT"
            }
        ));
    ...
    private void ACActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ACActionPerformed
        ...
        DefaultTableModel modelo1 = (DefaultTableModel) AdminData.tabla.getModel();

        datosArrayList = Consultas.selectAll();

        for (Object[] z : datosArrayList) {

            modelo1.addRow(z);

        }

        //PONEMOS EL MODELO Y LISTO
        AdminData.tabla.setModel(modelo1);
